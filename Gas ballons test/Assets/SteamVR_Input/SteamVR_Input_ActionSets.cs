...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_GasBallonInputSet p_GasBallonInputSet;
        ...
        public static SteamVR_Input_ActionSet_GasBallonInputSet GasBallonInputSet
        {
            get
            {
                return SteamVR_Actions.p_GasBallonInputSet.GetCopy<SteamVR_Input_ActionSet_GasBallonInputSet>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_GasBallonInputSet = ((SteamVR_Input_ActionSet_GasBallonInputSet)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_GasBallonInputSet>("/actions/GasBallonInputSet")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.GasBallonInputSet};
        }
    }
}
